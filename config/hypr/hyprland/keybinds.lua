...
hl.bind("SUPER + SHIFT + J", hl.dsp.global("quickshell:barToggle"), { description = "Shell: Toggle bar" })
...
--#/# bind = SUPER + ←/↑/→/↓,, -- Focus in direction (comentado, se usa para mover monitores)
-- for i = 1, 4 do
...
-- SUPER + C movido a custom/keybinds.lua (cierra ventana)
...
-- Cargar keybinds personalizados al final para pisar los de end-4
-- (también se carga desde hyprland.lua, pero por si acaso)
