...
brew "wget"
# AI-powered local git operations via MCP. Zero cloud tokens for git.
brew "blak0p/tap/git-courer"
# Persistent memory for AI coding agents. Agent-agnostic, single binary, zero dependencies.
brew "gentleman-programming/tap/engram", link: false
...
brew "gentleman-programming/tap/gentleman-dots", trusted: true
...
flatpak "com.parsecgaming.parsec"
...
flatpak "org.virt_manager.virt-viewer"
flatpak "sh.ppy.osu"
flatpak "xyz.xclicker.xclicker"
npm "@bitbonsai/mcpvault"
npm "@colbymchenry/codegraph"
npm "@gitbook/cli"
npm "@openai/codex"
npm "antigravity-usage"
npm "neovim"
npm "pnpm"
