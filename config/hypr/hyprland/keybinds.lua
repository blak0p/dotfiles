...
-- Window navigation
hl.bind("SUPER + J", hl.dsp.window.cycle_next(), { repeating = true })
hl.bind("SUPER + K", hl.dsp.window.cycle_next({ next = false }), { repeating = true })
...
hl.bind("SUPER + up", hl.dsp.window.move({ monitor = "-1" }))
hl.bind("SUPER + down", hl.dsp.window.move({ monitor = "+1" }))

-- Move window within workspace (direction)
