...
StyledWindow {
    ...
    Item {
        ...
        PanelBg {
            ...
            deformAmount: 0.2
            x: panels.sessionWrapper.x + panels.session.x
            y: panels.session.y + bar.implicitHeight
        ...
        PanelBg {
            ...
            y: panels.osd.y + bar.implicitHeight
        ...
        PanelBg {
            ...
            x: panels.popoutsWrapper.x + panels.popouts.x
            y: panels.popouts.y + bar.implicitHeight - panels.popouts.height * extraHeight
